      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ URL::to('') }}/public/assets/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ URL::to('') }}/public/assets/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ URL::to('') }}/public/assets/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
    ...
    <div class="sidebar">
      ...
      @if(Auth::guest())
        <div class="image">
          ...
          <a href="{{URL::to('')}}/signup">LogIn</a>
        </div>
        @else
        <div class="image">
          <img src="{{URL::to('')}}//public/assets/images/{{Auth::user()->image }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{URL::to('')}}/product/block" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Product Block List</p>
                </a>
              </li>
            </ul>
          </li>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{URL::to('')}}/category/create" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add New Categary</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{URL::to('')}}/category/block" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Categary Block List</p>
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{URL::to('')}}/order/block" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Block Order List</p>
                </a>
              </li>
            </ul>
          </li>
