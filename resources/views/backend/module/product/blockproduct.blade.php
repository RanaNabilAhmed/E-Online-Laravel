              ...
              <tbody>
                @foreach ($p as $product)
                  <tr>
                    ...
                    <td>
                      <a href="{{URL::to('')}}/product/active/{{ $product->id }}" type="button" class="btn btn-block btn-info">
                        Active
                      </a>
                      <a href="{{URL::to('')}}/product/delete/{{ $product->id }}" type="button" class="btn btn-block btn-warning">
                        Delete
                      </a>
                    </td>
                  </tr>
